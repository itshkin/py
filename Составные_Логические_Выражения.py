...
# Задача №2
"""2. Готовим завтрак. Можно приготовить хлопья с молоком (молоко, хлопья), можно яичницу (яйца), а можно омлет (
молоко и яйца). Есть и более бюджетные варианты. Вставьте логический оператор вместо многоточия и потестируйте. """
